...
<body id="body" style="background-image: url('static/images/backgrounds/bookcase.png'); ">
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<div class="block text-center">
						...
						<p class="mt-20">
							New to this site?<a href="register"> Create New Account</a>
						</p>
						<p>
							<a href="#" data-toggle="modal" data-target="#forgot"
								class="btn btn-link">Forgot your password?</a> | <a href="index"class="btn btn-link">Home</a>
						</p>
					</div>
				</div>
			</div>
